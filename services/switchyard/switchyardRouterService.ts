...
export const DEFAULT_SWITCHYARD_TARGETS: SwitchyardTarget[] = [
  ...
  {
    id: 'gemini_pro',
    name: 'Google Gemini 3 Pro (Deep Think)',
    provider: 'gemini',
...
export const DEFAULT_SWITCHYARD_ROUTES: SwitchyardRouteConfig[] = [
  {
    ...
    description: 'Starts with high-speed Groq LPU (280 tok/s). Escalates dynamically to Capable tier on complex schema or low-confidence audits.',
    efficientTarget: 'groq_llama70b',
    capableTarget: 'gemini_pro',
