    ...
    <div className="min-h-screen bg-black text-white selection:bg-gold selection:text-black font-['Outfit'] antialiased">
      ...
      <main className="relative z-10 pt-44 pb-32 max-w-7xl mx-auto px-6">
        <section className="text-center mb-40">
          <div className="inline-block px-5 py-2 rounded-full border border-gold/30 bg-gold/5 mb-12">
        ...
        <section className="mb-48 flex justify-center">
          <div className="w-full max-w-2xl p-12 glass-morphism rounded-[64px] border-gold/30 relative shadow-3xl">
