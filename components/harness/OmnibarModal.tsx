...
const DESTINATIONS: Destination[] = [
  ...
  { id: 'settings', label: 'Settings and AI keys', description: 'Connect Groq, NVIDIA or Ollama, and other keys.', keywords: 'settings keys api groq nvidia ollama gemini integrations', view: AppView.DASHBOARD, icon: ICONS.Settings, group: 'Tools' },
