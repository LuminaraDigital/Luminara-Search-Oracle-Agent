...
const DESTINATIONS: Destination[] = [
  ...
  { id: 'notebook', label: 'NotebookLM Studio', description: 'Grounded source intelligence, audio overview podcasts, and briefing docs.', keywords: 'notebook notebooklm studio sources audio podcast citations briefing guide study faq', view: AppView.NOTEBOOK, icon: ICONS.Notebook, group: 'Start here' },
