    ...
    <div className="max-w-4xl mx-auto px-4 py-8 animate-in fade-in duration-700">
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold/10 border border-gold/30 mb-4">
          <ICONS.Analyst className="w-4 h-4 text-gold-light" />
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gold-light">Quantitative Intelligence</span>
        </div>
      ...
      {dna && (
        <div className="mb-6 glass-morphism rounded-xl px-4 py-3 border border-success-500/30 flex items-center justify-between text-xs">
          ...
          <span className="text-[10px] font-mono text-success-400 uppercase tracking-widest">KPI Context Enabled</span>
        </div>
      )}
      ...
      {result && (
        <div className="glass-morphism rounded-2xl border border-gold/40 p-6 sm:p-8 shadow-2xl animate-in fade-in duration-500">
          <div className="flex items-center gap-3 border-b border-white/10 pb-4 mb-6">
            ...
            <h3 className="text-base font-bold uppercase tracking-widest text-gold-light">Executive Data Synthesis</h3>
          </div>
          <div 
