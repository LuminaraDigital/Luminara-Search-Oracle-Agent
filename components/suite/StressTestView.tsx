    ...
    <div className="max-w-4xl mx-auto px-4 py-8 animate-in fade-in duration-700">
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold/10 border border-gold/30 mb-4">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gold-light">Strategy</span>
        </div>
        <h1 className="text-3xl sm:text-5xl font-bold gold-text tracking-tight mb-3">
          Red Team Stress Test
        </h1>
        <p className="text-sm text-gray-400 max-w-xl mx-auto leading-relaxed">
          Stress-test your business model and assumptions against competitive pressure and market friction.
        </p>
      </div>
      ...
      <div className="glass-morphism rounded-2xl border border-gold/30 p-6 sm:p-8 mb-8 shadow-2xl space-y-6">
        <div>
          <label htmlFor="stress-test-input" className="block text-xs font-bold uppercase tracking-widest text-gray-300 mb-2">
          ...
          <textarea
            ...
            rows={6}
            className="w-full bg-black/60 border border-white/15 focus:border-gold rounded-xl p-4 text-sm text-white font-sans placeholder:text-gray-500 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none transition-all shadow-inner leading-relaxed resize-y"
          />
        </div>
          ...
          >
            {loading ? (
              <>
                ...
                <span>Simulating stress test…</span>
              </>
            ) : (
              <>
