...
const BASE =
  'inline-flex items-center justify-center gap-1.5 font-bold uppercase tracking-wider select-none transition-all outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-black disabled:opacity-50 disabled:cursor-not-allowed';
...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  ghost:
    'text-gray-400 bg-transparent hover:text-white hover:bg-white/5 focus-visible:ring-gold active:scale-[0.98] active:bg-white/10 disabled:hover:text-gray-400 disabled:hover:bg-transparent disabled:active:scale-100',
  danger:
